package com.rabbiter.lm.handler;

import com.rabbiter.lm.annotation.DisableBaseResponse;
import com.rabbiter.lm.model.support.ResponseResult;
 ...
 */
@ControllerAdvice(value = "com.rabbiter.lm.controller")
