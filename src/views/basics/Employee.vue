<template>
  <div>
    <a-button size="large" class="editable-add-btn" @click="visible = true;clearInput()">
      新增员工
    </a-button>
    <a-table :loading="loading" :columns="columns" :data-source="data" bordered rowKey="id">
      ...
      <template slot="operation" slot-scope="text, record, index">
        ...
        <span v-if="record.editable">
          ...
          <a-popconfirm title="取消修改?" :okText="'是'" :cancelText="'否'" @confirm="() => cancel(record.id)">
    ...
    >
      <a-form-model :model="form">
        ...
        <a-form-model-item label="所在仓库">
          <a-select v-model="form.department" v-for="(item,index) in warehouseList" :key="index" placeholder="请选择员工所在仓库">
